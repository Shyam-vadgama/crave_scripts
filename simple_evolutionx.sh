...
# Device tree
git clone https://github.com/Shyam-vadgama/device_xiaomi_warm -b evo device/xiaomi/warm
...
. build/envsetup.sh
lunch lineage_warm-ap4a-userdebug || lunch lineage_warm-bp4a-userdebug
m evolution
