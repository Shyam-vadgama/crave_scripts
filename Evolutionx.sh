...
if [ -z "$TELEGRAM_TOKEN" ] || [ -z "$TELEGRAM_CHAT_ID" ]; then
    echo "❌ TELEGRAM_TOKEN Or TELEGRAM_CHAT_ID unknown"
    echo "💡 Add ~/.bashrc:"
...
set +eE
. build/envsetup.sh
lunch lineage_warm_cp2a-userdebug || lunch lineage_warm-ap4a-user || lunch lineage_warm-ap4a-userdebug || lunch lineage_warm-bp4a-userdebug
set -eE
...
SUCCESS_MSG+="├─ 💿 <b>ROM:</b> Lineageos%0A"
